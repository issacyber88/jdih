<aside class="col-lg-4 sidebar sidebar--right">
          ...
          <div class="widget widget-reviews">
            <h4 class="widget-title">Berita Sulut</h4>
                  ...
                  <div class="post-list-small__img-holder">
                    <div class="thumb-container thumb-75">
                      <a href="single-post.html">
                        <img data-src="https://sulutprov.go.id/admin/<?php print $datax[$a]['gambar_brt']; ?>" src="https://sulutprov.go.id/admin/<?php print $datax[$a]['gambar_brt']; ?>" alt="" class=" lazyload">
                      </a>
                    </div>
                  </div>
          ...
          <div class="widget widget_mc4wp_form_widget">
            ...
            <form class="mc4wp-form" method="post" action="cari_ph.php">
            ...
            <div class="tabs widget-tabpost__tabs">
              ...
              <div class="tabs__content tabs__content-trigger widget-tabpost__tabs-content">
                ...
                <div class="tabs__content-pane tabs__content-pane--active" id="tab-perda">
                  <ul class="post-list-small">
                    <?php
                      $sqlv = mysqli_query($con, "SELECT * FROM peraturan, katalog WHERE id_kat = id_peraturan_cat AND id_kat = '3' ORDER BY id_peraturan DESC LIMIT 0,7");
                ...
                <div class="tabs__content-pane" id="tab-pergub">
                  <ul class="post-list-small">
                    <?php
                      $sqlv = mysqli_query($con, "SELECT * FROM peraturan, katalog WHERE id_kat = id_peraturan_cat AND id_kat = '4' ORDER BY id_peraturan DESC LIMIT 0,7");
                      while($datav = mysqli_fetch_array($sqlv)){
                    ?>
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
